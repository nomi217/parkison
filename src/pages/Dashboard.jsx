...
// import parkinsons from "../assets/parkinsons.jpg"; // Path to your image
// import { HiMicrophone, HiPencilAlt } from 'react-icons/hi';

// function Home() {
//   return (
//     <div className="bg-[#F8FAFF] min-h-screen pt-32 px-4 md:px-8 font-sans text-[#4A5568]">
//       <motion.div
...
//           </p>
//           <p className="text-lg">
//             This platform analyzes voice patterns using AI to predict the likelihood of Parkinson's, offering valuable insights for both patients and healthcare professionals.
//           </p>
//         </section>
...
//               <p className="text-lg">User uploads a handwritten sample for analysis.</p>
//             </div>
//             <div className="flex items-center space-x-4">
//               <HiMicrophone className="text-3xl text-[#00BFFF]" />
//               <p className="text-lg">System processes the voice recording and extracts features.</p>
//             </div>
//             <div className="flex items-center space-x-4">
//               <HiPencilAlt className="text-3xl text-[#00BFFF]" />
//               <p className="text-lg">System processes the handwritten input for analysis.</p>
//             </div>
//             <div className="flex items-center space-x-4">
//               <HiMicrophone className="text-3xl text-[#00BFFF]" />
//               <p className="text-lg">AI model analyzes both voice and handwriting data to predict Parkinson's risk.</p>
//             </div>
//             <div className="flex items-center space-x-4">
//               <HiPencilAlt className="text-3xl text-[#00BFFF]" />
//               <p className="text-lg">Results and personalized recommendations are displayed to the user.</p>
//             </div>
//           </div>
//         </section>

//         {/* Real-Time Demo Section */}
//         <section className="bg-[#00BFFF] p-6 rounded-xl shadow-lg space-y-6 mt-10">
//           <h2 className="text-3xl font-semibold text-white mb-6">Try a Voice Test or Handwritten Analysis</h2>
...
//             {/* Handwritten Image Analysis Button */}
//             <button className="bg-[#0090CC] text-white px-6 py-3 rounded-full hover:bg-[#006C8E] transition">
...
//         {/* For Patients and Doctors Sections */}
//         <section className="mt-12 flex flex-col md:flex-row items-center gap-8">
//           {/* For Patients Section */}
//           <div className="w-full md:w-1/2 p-6 bg-[#3498DB] rounded-lg shadow-lg text-white">
//             <h2 className="text-3xl font-semibold mb-4">Living Well with Parkinson’s: Key Recommendations</h2>
...
//           {/* For Doctors Section */}
//           <div className="w-full md:w-1/2 p-6 bg-[#2980B9] rounded-lg shadow-lg text-white">
//             <h2 className="text-3xl font-semibold mb-4">AI-Driven Parkinson’s Diagnosis: A Game Changer for Doctors</h2>
//             <ul className="space-y-6">
//               <li className="flex items-center text-lg">
